            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex flex-stack align-items-end pb-4 mt-n19">
                                <div class="symbol symbol-125px symbol-lg-150px symbol-fixed position-relative mt-n3">
                                    ...
                                    <img src="<?php echo e(asset(auth()->user()->photo? 'imgs/'.auth()->user()->photo:'assets/media/avatars/300-3.jpg')); ?>" alt="image" class="border border-white border-4" style="border-radius: 20px" />
                            ...
                            <div class="d-flex flex-stack flex-wrap align-items-end">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap fw-semibold fs-7 pe-2">
                                        ...
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary">TX</a>
                                        <span class="bullet bullet-dot h-5px w-5px bg-gray-400 mx-3"></span>
                ...
                <div id="kt_user_profile_nav" class="rounded bg-gray-200 d-flex flex-stack flex-wrap mb-9 p-2" data-kt-sticky="true" data-kt-sticky-name="sticky-profile-navs" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{target: '#kt_user_profile_panel'}" data-kt-sticky-left="auto" data-kt-sticky-top="70px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
                    ...
                    <ul class="nav flex-wrap border-transparent">
                        ...
                        <li class="nav-item my-1">
                            <a class="btn btn-sm btn-color-gray-600 bg-state-body btn-active-color-gray-800 fw-bolder fw-bold fs-6 fs-lg-base nav-link px-3 px-lg-4 mx-1 active" href="<?php echo e(url('dashboard')); ?>">Overview</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item my-1">
                            <a class="btn btn-sm btn-color-gray-600 bg-state-body btn-active-color-gray-800 fw-bolder fw-bold fs-6 fs-lg-base nav-link px-3 px-lg-4 mx-1" href="<?php echo e(url('profile')); ?>">Settings</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item my-1">
                ...
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                    ...
                    <div class="card-header cursor-pointer">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <a href="<?php echo e(url('profile')); ?>" class="btn btn-sm btn-primary align-self-center">Edit Profile</a>
                        <!--end::Action-->
                    </div>
                    <!--begin::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800"><?php echo e(auth()->user()->name); ?></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 fv-row">
                                <span class="fw-semibold text-gray-800 fs-6"><?php echo e(auth()->user()->email); ?></span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\keendash\resources\views/auth/dash.blade.php ENDPATH**/ ?>
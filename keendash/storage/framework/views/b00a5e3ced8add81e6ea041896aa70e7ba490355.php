...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Formmmmm-->
        <form  action="<?php echo e(route('ecomerce.store')); ?>" method="POST" id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" >
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div>
                                        ...
                                        <div class= "text-muted fs-7"> 
                                            <textarea  name="description" class="form-control mb-2" rows="1" data-kt-element="input" placeholder="Type a message" >
                                            </textarea> </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\keendash\resources\views/main.blade.php ENDPATH**/ ?>
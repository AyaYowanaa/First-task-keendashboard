            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form method="POST" action="<?php echo e(route('login')); ?>"class="form w-100"  >
                            <?php echo csrf_field(); ?>
                            <!--begin::Heading-->
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">Not a Member yet?
                              ...
                              <!--  <a href="<?php echo e(url('signup')); ?>" class="link-primary">Sign Up -->
                            </div>
                            <!--end::Sign up-->
                        </form>
                        <!--end::Form-->
...
<script src="<?php echo e(URL::asset('assets/js/custom/authentication/sign-in/general.js')); ?>"></script>
<!--end::Custom Javascript-->
<!--end::Javascript-->

</body>
</html><?php /**PATH C:\xampp\htdocs\keendash\resources\views/auth/login1.blade.php ENDPATH**/ ?>